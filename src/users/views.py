...
from extensions import csrf, ldap_manager, login_manager
...
def load_user(user_id):
    if current_app.config['AUTH_METHOD'] is None:
...
def login():
    ...
    if current_app.config['AUTH_METHOD'] not in (None, 'internal', 'ldap'):
